...
# You’ll find that we can build a little suspense during gameplay with some well-placed delays.
# The game can also be easier for users to understand if not everything happens instantly.
import time
...
# here are also several string methods that we haven’t gone over in detail but will use for this project:
#
